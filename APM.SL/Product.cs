  ...
  public class Product
  {
    ...
    public string Reason { get; set; }
        ...
        public decimal CalculateMargin(string costInput, string priceInput)
        {
          ...
          // if(!success ||price<0){throw new ArgumentException("The price must be a number 0 or greater","price");}
...
var price=Guard.ThrowIfNotPositiveDecimal(priceInput,"The price must be a number 0 or greater than 0","price");
